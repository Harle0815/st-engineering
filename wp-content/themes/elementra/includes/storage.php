...
if ( ! function_exists( 'elementra_storage_get' ) ) {
	/**
	 ...
	 */
	function elementra_storage_get( $var_name, $default = '' ) {
		global $ELEMENTRA_STORAGE;
		return isset( $ELEMENTRA_STORAGE[ $var_name ] ) ? $ELEMENTRA_STORAGE[ $var_name ] : $default;
	}
}

if ( ! function_exists( 'elementra_storage_set' ) ) {
	/**
	 ...
	 */
	function elementra_storage_set( $var_name, $value ) {
		global $ELEMENTRA_STORAGE;
		$ELEMENTRA_STORAGE[ $var_name ] = $value;
	}
}

if ( ! function_exists( 'elementra_storage_empty' ) ) {
	/**
	 ...
	 */
	function elementra_storage_empty( $var_name, $key = '', $key2 = '' ) {
		global $ELEMENTRA_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return empty( $ELEMENTRA_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return empty( $ELEMENTRA_STORAGE[ $var_name ][ $key ] );
		} else {
			return empty( $ELEMENTRA_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'elementra_storage_isset' ) ) {
	/**
	 ...
	 */
	function elementra_storage_isset( $var_name, $key = '', $key2 = '' ) {
		global $ELEMENTRA_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ] );
		} else {
			return isset( $ELEMENTRA_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'elementra_storage_unset' ) ) {
	/**
	 ...
	 */
	function elementra_storage_unset( $var_name, $key = '', $key2 = '' ) {
		global $ELEMENTRA_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			if ( isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ][ $key2 ] ) ) {
				unset( $ELEMENTRA_STORAGE[ $var_name ][ $key ][ $key2 ] );
			}
		} elseif ( '' !== $key ) {
			if ( isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) ) {
				unset( $ELEMENTRA_STORAGE[ $var_name ][ $key ] );
			}
		} else {
			if ( isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
				unset( $ELEMENTRA_STORAGE[ $var_name ] );
			}
		}
	}
}

if ( ! function_exists( 'elementra_storage_inc' ) ) {
	/**
	 ...
	 */
	function elementra_storage_inc( $var_name, $value = 1 ) {
		global $ELEMENTRA_STORAGE;
		if ( empty( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = 0;
		}
		$ELEMENTRA_STORAGE[ $var_name ] += $value;
	}
}

if ( ! function_exists( 'elementra_storage_concat' ) ) {
	/**
	 ...
	 */
	function elementra_storage_concat( $var_name, $value ) {
		global $ELEMENTRA_STORAGE;
		if ( empty( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = '';
		}
		$ELEMENTRA_STORAGE[ $var_name ] .= $value;
	}
}

if ( ! function_exists( 'elementra_storage_get_array' ) ) {
	/**
	 ...
	 */
	function elementra_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $ELEMENTRA_STORAGE;
		if ( '' === $key2 ) {
			return ! empty( $var_name ) && '' !== $key && isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) ? $ELEMENTRA_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && '' !== $key && isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $ELEMENTRA_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}

if ( ! function_exists( 'elementra_storage_set_array' ) ) {
	/**
	 ...
	 */
	function elementra_storage_set_array( $var_name, $key, $value ) {
		global $ELEMENTRA_STORAGE;
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			if ( '' === $key ) {
				$ELEMENTRA_STORAGE[ $var_name ][] = $value;
			} else {
				$ELEMENTRA_STORAGE[ $var_name ][ $key ] = $value;
			}
		}
	}
}

if ( ! function_exists( 'elementra_storage_set_array2' ) ) {
	/**
	 ...
	 * @param mixed  $value     A new value for the specified element of the array.
	 */
	function elementra_storage_set_array2( $var_name, $key, $key2, $value ) {
		global $ELEMENTRA_STORAGE;
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array();
		}
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ][ $key ] = array();
		}
		if ( is_array( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) ) {
			if ( '' === $key2 ) {
				$ELEMENTRA_STORAGE[ $var_name ][ $key ][] = $value;
			} else {
				$ELEMENTRA_STORAGE[ $var_name ][ $key ][ $key2 ] = $value;
			}
		}
	}
}

if ( ! function_exists( 'elementra_storage_merge_array' ) ) {
	/**
	 ...
	 */
	function elementra_storage_merge_array( $var_name, $key, $value ) {
		global $ELEMENTRA_STORAGE;
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array_merge( $ELEMENTRA_STORAGE[ $var_name ], $value );
		} else {
			$ELEMENTRA_STORAGE[ $var_name ][ $key ] = array_merge( $ELEMENTRA_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'elementra_storage_set_array_after' ) ) {
	/**
	 ...
	 */
	function elementra_storage_set_array_after( $var_name, $after, $key, $value = '' ) {
		global $ELEMENTRA_STORAGE;
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			elementra_array_insert_after( $ELEMENTRA_STORAGE[ $var_name ], $after, $key );
		} else {
			elementra_array_insert_after( $ELEMENTRA_STORAGE[ $var_name ], $after, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'elementra_storage_set_array_before' ) ) {
	/**
	 * Insert new elements to the array in the global theme storage
	 ...
	 * @param mixed        $value     A new value to insert (if the argument $key is a string).
	 */
	function elementra_storage_set_array_before( $var_name, $before, $key, $value = '' ) {
		global $ELEMENTRA_STORAGE;
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			elementra_array_insert_before( $ELEMENTRA_STORAGE[ $var_name ], $before, $key );
		} else {
			elementra_array_insert_before( $ELEMENTRA_STORAGE[ $var_name ], $before, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'elementra_storage_push_array' ) ) {
	/**
	 ...
	 */
	function elementra_storage_push_array( $var_name, $key, $value ) {
		global $ELEMENTRA_STORAGE;
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			array_push( $ELEMENTRA_STORAGE[ $var_name ], $value );
		} else {
			if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) ) {
				$ELEMENTRA_STORAGE[ $var_name ][ $key ] = array();
			}
			array_push( $ELEMENTRA_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'elementra_storage_pop_array' ) ) {
	/**
	 ...
	 */
	function elementra_storage_pop_array( $var_name, $key = '', $defa = '' ) {
		global $ELEMENTRA_STORAGE;
		$rez = $defa;
		if ( '' === $key ) {
			if ( isset( $ELEMENTRA_STORAGE[ $var_name ] ) && is_array( $ELEMENTRA_STORAGE[ $var_name ] ) && count( $ELEMENTRA_STORAGE[ $var_name ] ) > 0 ) {
				$rez = array_pop( $ELEMENTRA_STORAGE[ $var_name ] );
			}
		} else {
			if ( isset( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) && is_array( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) && count( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) > 0 ) {
				$rez = array_pop( $ELEMENTRA_STORAGE[ $var_name ][ $key ] );
			}
		}
		return $rez;
	}
...
if ( ! function_exists( 'elementra_storage_inc_array' ) ) {
	/**
	 ...
	 * @param int          $value     Optional. A value for increment. Default is 1. Specify -1 to decrement or any legal number value.
	 */
	function elementra_storage_inc_array( $var_name, $key, $value = 1 ) {
		global $ELEMENTRA_STORAGE;
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array();
		}
		if ( empty( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ][ $key ] = 0;
		}
		$ELEMENTRA_STORAGE[ $var_name ][ $key ] += $value;
	}
}

if ( ! function_exists( 'elementra_storage_concat_array' ) ) {
	/**
	 ...
	 * @param int          $value     A value to concatenate.
	 */
	function elementra_storage_concat_array( $var_name, $key, $value ) {
		global $ELEMENTRA_STORAGE;
		if ( ! isset( $ELEMENTRA_STORAGE[ $var_name ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ] = array();
		}
		if ( empty( $ELEMENTRA_STORAGE[ $var_name ][ $key ] ) ) {
			$ELEMENTRA_STORAGE[ $var_name ][ $key ] = '';
		}
		$ELEMENTRA_STORAGE[ $var_name ][ $key ] .= $value;
	}
}

if ( ! function_exists( 'elementra_storage_call_obj_method' ) ) {
	/**
	 ...
	 */
	function elementra_storage_call_obj_method( $var_name, $method, $param = null ) {
		global $ELEMENTRA_STORAGE;
		if ( null === $param ) {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $ELEMENTRA_STORAGE[ $var_name ] ) ? $ELEMENTRA_STORAGE[ $var_name ]->$method() : '';
		} else {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $ELEMENTRA_STORAGE[ $var_name ] ) ? $ELEMENTRA_STORAGE[ $var_name ]->$method( $param ) : '';
		}
	}
}

if ( ! function_exists( 'elementra_storage_get_obj_property' ) ) {
	/**
	 ...
	 */
	function elementra_storage_get_obj_property( $var_name, $prop, $default = '' ) {
		global $ELEMENTRA_STORAGE;
		return ! empty( $var_name ) && ! empty( $prop ) && isset( $ELEMENTRA_STORAGE[ $var_name ]->$prop ) ? $ELEMENTRA_STORAGE[ $var_name ]->$prop : $default;
	}
}
