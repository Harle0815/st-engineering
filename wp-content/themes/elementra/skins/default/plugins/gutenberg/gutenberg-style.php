...
if ( ! function_exists( 'elementra_gutenberg_get_css' ) ) {
	add_filter( 'elementra_filter_get_css', 'elementra_gutenberg_get_css', 10, 2 );
	function elementra_gutenberg_get_css( $css, $args ) {
